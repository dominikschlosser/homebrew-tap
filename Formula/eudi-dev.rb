...
# repository by the release workflow. 2.3.2 (without the leading v) and
# 022844718350fe6b819515cbd4e5319b938b4bedcfc36023fa32bc4de4cc19c9 are filled in per release.
class EudiDev < Formula
  ...
  url "https://github.com/dominikschlosser/eudi-dev/archive/refs/tags/v2.3.2.tar.gz"
  sha256 "022844718350fe6b819515cbd4e5319b938b4bedcfc36023fa32bc4de4cc19c9"
  license "Apache-2.0"
