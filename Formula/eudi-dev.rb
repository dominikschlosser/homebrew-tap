...
# repository by the release workflow. 1.25.5 (without the leading v) and
# 42751fb45bf1fef90aba3bbcc800b4b6f0ea10b9e6ba124b56367db0980192e0 are filled in per release.
class EudiDev < Formula
  ...
  url "https://github.com/dominikschlosser/eudi-dev/archive/refs/tags/v1.25.5.tar.gz"
  sha256 "42751fb45bf1fef90aba3bbcc800b4b6f0ea10b9e6ba124b56367db0980192e0"
  license "Apache-2.0"
