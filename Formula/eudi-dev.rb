...
# repository by the release workflow. 2.3.3 (without the leading v) and
# 4a61577da0363b286a05a6ff9f26b16bcd465b5421d6e5e85ea44de4b4875aa5 are filled in per release.
class EudiDev < Formula
  ...
  url "https://github.com/dominikschlosser/eudi-dev/archive/refs/tags/v2.3.3.tar.gz"
  sha256 "4a61577da0363b286a05a6ff9f26b16bcd465b5421d6e5e85ea44de4b4875aa5"
  license "Apache-2.0"
