...
# repository by the release workflow. 1.21.4 (without the leading v) and
# cd90669df180771a0143916b9ac8625ffc0528108e52763fde543ab534986310 are filled in per release.
class EudiDev < Formula
  ...
  url "https://github.com/dominikschlosser/eudi-dev/archive/refs/tags/v1.21.4.tar.gz"
  sha256 "cd90669df180771a0143916b9ac8625ffc0528108e52763fde543ab534986310"
  license "Apache-2.0"
