...
# repository by the release workflow. 1.15.3 (without the leading v) and
# b9064f7fa1aded3e775eafda542ea173cb5cb827860ff5251a45b2da50e576d5 are filled in per release.
class EudiDev < Formula
  ...
  url "https://github.com/dominikschlosser/eudi-dev/archive/refs/tags/v1.15.3.tar.gz"
  sha256 "b9064f7fa1aded3e775eafda542ea173cb5cb827860ff5251a45b2da50e576d5"
  license "Apache-2.0"
