...
# repository by the release workflow. 1.18.7 (without the leading v) and
# 7bd5bfbeb441a73b7d64c07718aff5e5bbd2cab92c0a61a0633c386e448a81a3 are filled in per release.
class EudiDev < Formula
  ...
  url "https://github.com/dominikschlosser/eudi-dev/archive/refs/tags/v1.18.7.tar.gz"
  sha256 "7bd5bfbeb441a73b7d64c07718aff5e5bbd2cab92c0a61a0633c386e448a81a3"
  license "Apache-2.0"
